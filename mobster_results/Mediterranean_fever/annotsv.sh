...
do
    ...
    export DIR="/scratch/lab_genresearch/ahirata/ahirata/mobster_results/fmf_bams/AY48"$i"/Results/";
    export INPUT="/scratch/lab_genresearch/ahirata/ahirata/mobster_results/fmf_bams/AY48"$i"/Results/Final_AY48"$i".vcf";
