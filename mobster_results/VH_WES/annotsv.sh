...
do
    ...
    for j in $range
    do
        export DIR="/scratch/lab_genresearch/ahirata/ahirata/mobster_results/WES_ME/"${pattern}${j}"/Results";
        export INPUT="/scratch/lab_genresearch/ahirata/ahirata/mobster_results/WES_ME/"${pattern}${j}"/Results/Final_"${pattern}${j}".vcf";
