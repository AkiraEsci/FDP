...
do
    if [ $i -eq 41 ] || [ $i -eq 54 ] || [ $i -eq 55 ]; then
        export DIR="/gpfs42/projects/lab_genresearch/shared_data/ahirata/MELT_results/Family/AY49"$i"/Results";
        export INPUT="/gpfs42/projects/lab_genresearch/shared_data/ahirata/MELT_results/Family/AY49"$i"/Results/Final_AY49"$i".vcf";       
