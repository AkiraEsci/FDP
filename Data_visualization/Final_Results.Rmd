...
## BQSR 
```{r, message=FALSE}
setwd("/home/theoverseer/Downloads/VHWESWGS/")
...
final_plot <- (plot_list[[1]] | plot_list[[2]] | plot_list[[3]]) + plot_annotation(title = "Figure S1: Number of TEs per Individual detected by each tool", caption = "Source: CVID")
print(final_plot)
...
final_plot <- (plot_list[[1]] | plot_list[[2]] | plot_list[[3]]) + plot_annotation(title = "Figure S6: Number of TEs per Individual detected by each tool with S24", caption = "Source: CVID")
print(final_plot)
...
final_plot <- (plot_list[[1]] | plot_list[[2]] | plot_list[[3]]) + plot_annotation(title = "Figure S2: Number of TEs per Individual detected by each tool", caption = "Source: ARG")
print(final_plot)
...
final_plot <- (plot_list[[1]] | plot_list[[2]] | plot_list[[3]]) + plot_annotation(title = "Figure S3: Number of TEs per Individual detected by each tool", caption = "Source: FMF")
print(final_plot)
...
final_plot <- (plot_list[[1]] | plot_list[[2]] | plot_list[[3]]) + plot_annotation(title = "Figure S4: Number of TEs per Individual detected by each tool", caption = "Source: VH WES")
print(final_plot)
...
final_plot <- (plot_list[[1]] | plot_list[[2]] | plot_list[[3]]) + plot_annotation(title = "Figure S5: Number of TEs per Individual detected by each tool", caption = "Source: VH WGS")
print(final_plot)
...
final_plot <- ggplot(gene_counts, aes(x = Tool, y = Count, fill = Tool, label = Gene_name)) +geom_bar(stat = "identity")  +labs(title = "Figure S9. Number of candidate genes (IEI) detected by each method", x = "Tool", y = "Count", caption = "Source: VH WGS") +theme_minimal() + scale_fill_manual(values = type_colors)
print(final_plot)
...
common_results_initial <- Reduce(intersect, list(set1, set2, set3))
library(RColorBrewer)
...
final_plot <- ggplot(data = gene_counts, aes(x = Sample, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S13. Number of TEs in CVID per tool",y = "Number of TEs",caption = "Source: CVID",fill = "Method")
print(final_plot)
...
type_colors <- c("Melt" = vcolors[1], "Mobster" = vcolors[2], "Scramble" = vcolors[3])
gene_counts <- combined_data %>%group_by(Sample, Method) %>% summarise(Count = n_distinct(Gene))
final_plot <- ggplot(data = gene_counts, aes(x = Sample, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S14. Number of TEs in ARG per tool",y = "Number of TEs",caption = "Source: ARG",fill = "Method")
print(final_plot)
...
type_colors <- c("Melt" = vcolors[1], "Mobster" = vcolors[2], "Scramble" = vcolors[3])
gene_counts <- combined_data %>%group_by(Sample, Method) %>% summarise(Count = n_distinct(Gene))
final_plot <- ggplot(data = gene_counts, aes(x = Sample, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S15. Number of TEs in FMF patients per tool",y = "Number of TEs",caption = "Source: FMF",fill = "Method") + theme(axis.text.x = element_text(angle = 65, vjust = 1.25, hjust=0.85))
print(final_plot)
...
scramble <- read_csv("scramble/exp_obs_gene_VHWES_scramble.csv") %>% distinct() 
melt <- melt[,1:7]
mobster <- mobster[,1:7]
scramble <- scramble[,1:7]
set1 <- paste(melt$Sample,melt$Chromosome,melt$Gene, sep="_")
...
type_colors <- c("Melt" = vcolors[1], "Mobster" = vcolors[2], "Scramble" = vcolors[3])
gene_counts <- combined_data %>%group_by(Sample, Method) %>% summarise(Count = n_distinct(Gene))
final_plot <- ggplot(data = gene_counts, aes(x = Sample, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S16. Number of TEs in VH WES data per tool",y = "Number of TEs",caption = "Source: VH WES",fill = "Method") + theme(axis.text.x = element_text(angle = 65, vjust = 1.25, hjust=0.85))
print(final_plot)
...
type_colors <- c("Melt" = vcolors[1], "Mobster" = vcolors[2], "Scramble" = vcolors[3])
gene_counts <- combined_data %>%group_by(Sample, Method) %>% summarise(Count = n_distinct(Gene))
final_plot <- ggplot(data = gene_counts, aes(x = Sample, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S17. Number of TEs in VH WGS data per tool",y = "Number of TEs",caption = "Source: VH WGS",fill = "Method") + theme(axis.text.x = element_text(angle = 65, vjust = 1.25, hjust=0.85))
print(final_plot)
...
analyze_data <- function(df1_path, df2_path, sample1, sample2, method_name) {
  ...
  plot1 <- ggplot(data = not_common_rows_WES, mapping = aes(x = Sample, fill = Distance_Tag)) + geom_bar() + theme_minimal() + scale_fill_viridis_d() + labs(title = paste0("Type of distance individual ", sample1, "/", sample2, " ", method_name), y = "Nºdistance tag per sample", caption = "Source: VH data WES", fill="Distance Tag")
  ...
  plot2 <- ggplot(data = not_common_rows, mapping = aes(x = Sample, fill = Distance_Tag)) + geom_bar() + theme_minimal() + scale_fill_viridis_d() + labs(y = "Nºdistance tag per sample", caption = "Source: VH data WGS", fill="Distance Tag")
  plot3 <- ggplot(data = not_common_rows[not_common_rows$Distance_Tag %in% c("Inside","Close"),], mapping = aes(x = Sample, fill = Distance_Tag)) + geom_bar() + theme_minimal() + scale_fill_viridis_d() + labs(y = "Nºdistance tag per sample", caption = "Source: VH data WGS only Inside,Close", fill="Distance Tag")
  only_inside <- not_common_rows[not_common_rows$Distance_Tag %in% c("Inside","Close"),]
  ...
  return(list(plots = list(plot1, plot2, plot3), venn_diagram = venn_diagram, filename = filename, venn_filename = venn_filename, not_common_rows_WES = not_common_rows_WES, only_inside = only_inside, sample1 = sample1, sample2 = sample2))
}
...
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "S58", "VH17i", "SCRAMble")
...
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2

not_common_melt <- result_melt$not_common_rows_WES
not_common_mobster <- result_mobster$not_common_rows_WES
not_common_scramble <- result_scramble$not_common_rows_WES

set1 <- paste(not_common_melt$Chromosome, not_common_melt$Gene, sep="_")
set2 <- paste(not_common_mobster$Chromosome, not_common_mobster$Gene, sep="_")
set3 <- paste(not_common_scramble$Chromosome, not_common_scramble$Gene, sep="_")
library(RColorBrewer)
myCol <- brewer.pal(3, "Pastel2")
venn.diagram(
    x = list(set1, set2, set3),
    category.names = c("MELT" , "mobster" , "SCRAMble"),
    filename = paste0('Comparison_', sample1,"_",sample2,"only_WES", '.png'),
    output = TRUE,
...
not_common_melt <- result_melt$only_inside
not_common_mobster <- result_mobster$only_inside
not_common_scramble <- result_scramble$only_inside
...
venn.diagram(
    x = list(set1, set2, set3),
    category.names = c("MELT" , "mobster" , "SCRAMble"),
    filename = paste0('Comparison_', sample1,"_",sample2,"only_WGS_inside", '.png'),
    output = TRUE,
...
result_melt$plots[[3]]
result_mobster$plots[[3]]
result_scramble$plots[[3]]
```
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv",  "S59" , "VH17f", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv",  "S60" , "VH17m", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH60" , "VH11s", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH61" , "VH11i", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH63" , "VH11f", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH71" , "VH16i", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv",  "VH72" , "VH16m", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv",  "VH73" , "VH16f", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH77" , "VH01i", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH78" , "VH01m", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
save_plots(result_mobster$plots, result_mobster$filename)
save_venn(result_mobster$venn_diagram, result_mobster$venn_filename)
result_scramble <- analyze_data("scramble/exp_obs_gene_VHWES_scramble.csv", "scramble/exp_obs_gene_VH_scramble.csv", "VH79" , "VH01f", "SCRAMble")
save_plots(result_scramble$plots, result_scramble$filename)
save_venn(result_scramble$venn_diagram, result_scramble$venn_filename)
sample1 <- result_melt$sample1
sample2 <- result_melt$sample2
...
denovo_plot <- ggplot(data = gene_counts, aes(x = Family, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S10. Number of de novo insertions detected in WGS trios per tool",y = "Number of De novo detected",caption = "Source: VH WGS",fill = "Method")
print(denovo_plot)
ggsave(filename = "Final_plots/denovoWGS.png",denovo_plot, width = 15, height = 7)
denovogenes_plot <- ggplot(data = common_results, mapping = aes(x = Family, fill = Gene)) + geom_bar() + theme_minimal() + scale_fill_viridis_d() + labs(title="Figure S11. Genes from De novo insertion detected in WGS trios",y = "Number of de novo detected", caption = "Source: VH WGS", fill = "Genes")
...
type_colors <- c("Melt" = vcolors[1], "Mobster" = vcolors[2], "Scramble" = vcolors[3])
gene_counts <- combined_data %>%group_by(Family, Method) %>% summarise(Count = n_distinct(Gene))
denovoWES_plot <- ggplot(data = gene_counts, aes(x = Family, y = Count, fill = Method)) + geom_bar(stat = "identity", position = "dodge") +theme_minimal() + scale_fill_manual(values = type_colors) +labs(title="Figure S12. Number of de novo insertions detected in WES trios per tool",y = "Number of De novo detected",caption = "Source: VH WES",fill = "Method")
print(denovoWES_plot)
ggsave(filename = "Final_plots/denovoWES.png",denovoWES_plot, width = 15, height = 7)
denovogenesWES_plot <- ggplot(data = common_results, mapping = aes(x = Family, fill = Gene)) + geom_bar() + theme_minimal() + scale_fill_viridis_d() + labs(title="Figure S13. Genes from de novo insertions detected in WES trios",y = "Number of De novo detected", caption = "Source: VH WES", fill = "Genes")
...
rMETL_plot <- ggplot(data = data, aes(x = Sample, fill = Type)) + geom_bar() + labs(title = "Figure S43: Number of type of TEs detected by rMETL", y = "Number of TEs", caption = "Source: LR") + theme_minimal() + scale_fill_viridis_d() 
print(rMETL_plot)
...
ggplot(data = data, aes(x = Sample, fill = Distance_Tag)) + geom_bar() + labs(title = "Number of tag distance - rMETL",y = "Number of TEs",caption = "Source:  LR") + theme_minimal() + scale_fill_viridis_d() 
```
```{r, message=FALSE}
setwd("/home/theoverseer/Downloads/VHWESWGS/")
data <- read_csv("rMETL/Longreads_scramble_final.csv")  %>% distinct()
rMETL_plot <- ggplot(data = data, aes(x = Sample, fill = Type)) + geom_bar() + labs(title = "Figure S44: Number of type of TEs detected by SCRAMble", y = "Number of TEs", caption = "Source: LR") + theme_minimal() + scale_fill_viridis_d() 
print(rMETL_plot)
...
ggplot(data = data, aes(x = Sample, fill = Distance_Tag)) + geom_bar() + labs(title = "Number of tag distance - SCRAMble",y = "Number of TEs",caption = "Source:  LR") + theme_minimal() + scale_fill_viridis_d() 
```
