...
do
    ...
    export DIR="/gpfs42/projects/lab_genresearch/shared_data/ahirata/SCRAMble_results/VH/"$dir_name"/Results";
    export INPUT="/gpfs42/projects/lab_genresearch/shared_data/ahirata/SCRAMble_results/VH/"$dir_name"/Results/Final_"$dir_name".vcf";
